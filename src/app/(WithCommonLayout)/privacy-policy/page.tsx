...
import { privacyPolicyPageMetadata } from '@/utils/Metadata';
import { privacyPolicyPageSchemaData } from '@/utils/SchemaData';
...
const PrivacyPolicyPage = () => {
  const schemaData = privacyPolicyPageSchemaData;

  return (
    <>
      <Script
        id="schema-markup-privacy-policy"
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="dark:text-white text-justify">
                ...
                address, phone number, and property details when you use our
                platform. Additionally, we may collect browsing data through
            ...
            <section>
              ...
              <p className="dark:text-white text-justify">
                ...
                data. If you wish to modify your information or opt-out of
                certain services, please{' '}
                <Link
                  href="/"
