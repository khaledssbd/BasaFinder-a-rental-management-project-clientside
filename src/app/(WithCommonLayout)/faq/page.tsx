      ...
      <div className="md:mx-20">
        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              BasaFinder connects tenants with landlords by providing a seamless
              platform for renting homes. Tenants can browse verified listings,
              and landlords can list their properties with ease.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              Yes! Browsing properties is completely free for tenants. However,
              landlords may need to pay a small fee for premium listings and
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent>
              You can list your property by creating an account and filling out
              the property details in the dashboard.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-6">
            ...
            <AccordionContent>
              ...
              allowing you to directly message the property owner via our secure
              platform.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-9">
            ...
            <AccordionContent>
              Absolutely! Landlords can sign up, submit their property details,
              and start receiving inquiries from potential tenants instantly.
            </AccordionContent>
          </AccordionItem>
