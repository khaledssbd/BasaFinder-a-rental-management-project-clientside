...
import { aboutUsPageMetadata } from '@/utils/Metadata';
import { aboutUsPageSchemaData } from '@/utils/SchemaData';
...
const AboutUsPage = () => {
  const schemaData = aboutUsPageSchemaData;

  return (
    <>
      <Script
        id="schema-markup-about-us"
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="dark:text-white text-justify">
                ...
                process. We aim to provide a reliable and efficient platform
                where tenants can find their ideal home and landlords can
                connect with genuine tenants. Our goal is to make renting
            ...
            <section>
              ...
              <p className="dark:text-white text-justify">
                ...
                can find the right place to call home. Our journey has been
                driven by a passion for innovation and a commitment to customer
                satisfaction.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="dark:text-white text-justify">
                ...
                house, BasaFinder makes it easy to find your dream rental.
                Explore our listings and start your journey today.
              </p>
