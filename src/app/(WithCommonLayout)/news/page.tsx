...
import { newsPageMetadata } from '@/contants';
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="dark:text-white text-justify">
              Discover recent shifts in the rental market, pricing updates, and
              key insights that will help tenants and landlords make informed
              decisions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="dark:text-white text-justify">
              Get expert advice on house hunting, rental agreements, and making
              the most out of BasaFinder&apos;s features.
            </p>
          </section>
        </div>
      </div>
